...
COPY public.device (id, address, description, maximum_hourly_energy_consumption, name, id_user) FROM stdin;
37	Strada Richerdson nr 33	Smart Phone for rich people	100	Iphone 13	36
...
COPY public.measurement (id, energy_consumption, unity_of_measurement, date, "time", id_device) FROM stdin;
...
--
-- Name: measurement fkm4vis87tco7yahhtf4eu3f30c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.measurement
    ADD CONSTRAINT fkm4vis87tco7yahhtf4eu3f30c FOREIGN KEY (id_device) REFERENCES public.device(id);


--
-- Name: device fkq5nfgyrpmghpc4vsn3l5f4uqp; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.device
    ADD CONSTRAINT fkq5nfgyrpmghpc4vsn3l5f4uqp FOREIGN KEY (id_user) REFERENCES public.user_account(id);
