...
ChartModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.1.1", ngImport: i0, type: ChartModule, deps: [{ token: i1.ChartService }], target: i0.ɵɵFactoryTarget.NgModule });
